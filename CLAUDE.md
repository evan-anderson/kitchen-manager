...
Telegram bot acting as a family kitchen assistant (Evan, Danica, Oliver). Tracks pantry/fridge/freezer inventory via natural-language messages, answers inventory questions, and generates a weekly meal plan + grocery list every Saturday morning for Costco shopping.
...
- Danica (non-technical user) must actually use it — low friction over technical elegance.
