...
**Checkpoint**: Evan uses it daily for a week before adding Danica. Log everything.
...
**Checkpoint**: Danica joins. Collect 1 week of real usage.
...
**Checkpoint**: Use the plan for two Costco runs. Iterate on prompt based on what Danica actually finds useful.
